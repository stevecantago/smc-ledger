-- Migration 013: Add custom household roles and role permission matrix
...
COMMENT ON TABLE household_roles IS 'Custom household roles shown in the Role Permissions Matrix';
COMMENT ON TABLE role_permissions IS 'Fixed permission keys and editable permission levels for household roles';
